...
ActiveRecord::Schema.define(version: 2023_01_13_161012) do
  ...
  create_table "hospitals", force: :cascade do |t|
    t.string "name"
    t.bigint "doctors_id"
    t.index ["doctors_id"], name: "index_hospitals_on_doctors_id"
  end
  ...
  add_foreign_key "hospitals", "doctors", column: "doctors_id"
end
